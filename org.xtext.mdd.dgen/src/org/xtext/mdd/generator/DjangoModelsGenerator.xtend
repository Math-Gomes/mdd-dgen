...
class DjangoModelsGenerator extends AbstractGenerator {
    ...
    private def createAttributes(Feature f)'''
        ...
        ELSEIF f.type.name == "Int"    »models.models.BigIntegerField()«
        ELSEIF f.type.name == "Float"  »models.models.FloatField()«
        ELSEIF f.type.name == "Bool"   »models.models.BooleanField()«
        ELSEIF f.type.name == "Date"   »models.models.DateTimeField(default=timezone.now)«
