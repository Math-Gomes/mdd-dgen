 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.mdd.dgen.impl.DomainmodelImpl#getElements <em>Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DomainmodelImpl extends MinimalEObjectImpl.Container implements Domainmodel
{
  ...
  {
    return DgenPackage.Literals.DOMAINMODEL;
  }
  ...
  public EList<Type> getElements()
  {
    if (elements == null)
    {
      elements = new EObjectContainmentEList<Type>(Type.class, this, DgenPackage.DOMAINMODEL__ELEMENTS);
    }
    return elements;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case DgenPackage.DOMAINMODEL__ELEMENTS:
