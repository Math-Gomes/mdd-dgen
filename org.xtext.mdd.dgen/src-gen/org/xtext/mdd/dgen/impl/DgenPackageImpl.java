...
import org.xtext.mdd.dgen.DgenFactory;
 ...
 * @generated
 */
public class DgenPackageImpl extends EPackageImpl implements DgenPackage
{
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  private EClass viewOptionsEClass = null;
   ...
   * @see org.xtext.mdd.dgen.DgenPackage#eNS_URI
   * @see #init()
   * @generated
   */
  private DgenPackageImpl()
  {
    super(eNS_URI, DgenFactory.eINSTANCE);
  }
   ...
   *
   * <p>This method is used to initialize {@link DgenPackage#eINSTANCE} when that field is accessed.
   ...
   * @generated
   */
  public static DgenPackage init()
  {
    if (isInited) return (DgenPackage)EPackage.Registry.INSTANCE.getEPackage(DgenPackage.eNS_URI);

    // Obtain or create and register package
    Object registeredDgenPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
    DgenPackageImpl theDgenPackage = registeredDgenPackage instanceof DgenPackageImpl ? (DgenPackageImpl)registeredDgenPackage : new DgenPackageImpl();

    isInited = true;

    // Create package meta-data objects
    theDgenPackage.createPackageContents();

    // Initialize created meta-data
    theDgenPackage.initializePackageContents();

    // Mark meta-data to indicate it can't be changed
    theDgenPackage.freeze();

    // Update the registry and return the package
    EPackage.Registry.INSTANCE.put(DgenPackage.eNS_URI, theDgenPackage);
    return theDgenPackage;
  }
   ...
   */
  @Override
  public EReference getEntity_Views()
  {
   ...
   */
  @Override
  public EClass getViewOptions()
  {
    return viewOptionsEClass;
  }
   ...
   */
  @Override
  public EAttribute getViewOptions_Name()
  {
    return (EAttribute)viewOptionsEClass.getEStructuralFeatures().get(0);
  }
   ...
   */
  @Override
  public EReference getViews_ViewOption()
  {
   ...
   */
  @Override
  public DgenFactory getDgenFactory()
  {
    return (DgenFactory)getEFactoryInstance();
  }
  ...
  public void createPackageContents()
  {
    ...
    createEReference(entityEClass, ENTITY__VIEWS);
    ...
    viewOptionsEClass = createEClass(VIEW_OPTIONS);
  ...
  public void initializePackageContents()
  {
    ...
    initEReference(getEntity_Views(), this.getViews(), null, "views", null, 0, 1, Entity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEClass(viewOptionsEClass, ViewOptions.class, "ViewOptions", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
